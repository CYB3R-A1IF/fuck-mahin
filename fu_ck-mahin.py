...
def banner():
    #os.system('clear')
    print(f"""   
   _______     ______ ____  _____              __ _____ ______ 
  / ____\ \   / /  _ \___ \|  __ \        /\  /_ |_   _|  ____|
 | |     \ \_/ /| |_) |__) | |__) |_____ /  \  | | | | | |__   
 | |      \   / |  _ <|__ <|  _  /______/ /\ \ | | | | |  __|  
 | |____   | |  | |_) |__) | | \ \     / ____ \| |_| |_| |     
  \_____|  |_|  |____/____/|_|  \_\   /_/    \_\_|_____|_|     
                                                               
                                                            
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} CYB3R-A1IF                 {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}Md Alif             {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801xxxxxxxxx          {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/CYB3R-A1IF{N}    {H}  ║
...
def mainx():
    ...
    if Alif in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/CYB3R-A1IF");mainx()
    elif Alif in ["8","08"]:
 ...
 try:
  for ps in pw:
   ...
   header_freefb = {
    ...
    'upgrade-insecure-requests': '1',
    'user-agent': 'Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36',
    'viewport-width': '400': pro} #'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Safari/537.36',}
